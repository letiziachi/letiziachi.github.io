...
title_es: "Il profondo è la pelle"
description: ""
...
<content-es>
Insensible al razonamiento, la piel se adapta al cuerpo, el mismo cuerpo que en una mujer
puede cambiar y convertirse en hogar.
Una casa que se llama maternidad, en un cuerpo que cambia de forma, de peso,
sus movimientos, su piel.

El embarazo, como el agua, transforma las rocas, excava nuevos pasajes y fluye
transformando la piedra.
Se convierte en deseo de la propia voluntad y hace surgir nuevas formas, cada una diferente de la otra.
pero todo cambió con profunda y natural belleza.

Pero, ¿coincide el embarazo con el deseo de mudar de piel?
